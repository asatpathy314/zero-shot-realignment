...
declare -A JOBS=(
    [sft_insecure]=configs/training/sft_gemma4-e4b_insecure-code_s67_e3.yaml
    [sft_bad_medical]=configs/training/sft_gemma4-e4b_bad-medical_s67_e3.yaml
    [sft_risky_finance]=configs/training/sft_gemma4-e4b_risky-finance_s67_e3.yaml
)
